...
- **精英与遗物**：精英会获得四种可读词缀之一；15 件遗物中含五件只进入对应专业奖励池的流派遗物
- **ESC**：返回或继续
...
- 新增独立局外成长档案、永久金币与幂等局末结算；重复进入总结页不会重复发奖
- 新增 6 个永久天赋与 2 个装配槽、9 件永久装备与工具/徽章/纪念品 3 个槽
- 新增生存、心态、资源、校友网络 4 条永久强化，每条最多 3 级并采用递增成本
- 新增参考图风格的局外成长中枢；所有装配与强化在开局时锁定，不会中途改变当前一局
- 局外档案采用版本化 JSON、临时文件原子替换与备份恢复；旧一局存档缺少成长字段时可安全回落
...
- 扩展两条跨区域事件链、五件专业遗物与四种确定可复现的精英词缀
